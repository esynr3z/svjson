...
Please refer to xref:user.adoc#json-decoder[User Guide: JSON Decoder] section.

== How to dump JSON file or string?

Please refer to xref:user.adoc#json-encoder[User Guide: JSON Encoder] section.
